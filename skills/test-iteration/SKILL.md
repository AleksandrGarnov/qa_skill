...
**Done when:** the adversarial subagent has run; every landed attack has a reproducing test and is recorded (unfixed); and all scenarios (landed + not-landed) are queued for the checklist.
